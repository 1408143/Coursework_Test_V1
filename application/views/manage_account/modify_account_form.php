		...
		?>
			...
			<div class="container">
				<div class="row">		
					<?php
						//form-inline
						echo form_open('manage_account/modify_account', 'class="form-group"');
							...
							echo '<h3>Change your password</h3>';
								...
								//form-group
								echo '<div class="form-group">';
									echo form_submit('modify_account_password','Modify','class="btn btn-default"');
								echo '</div>';
							echo '</div>';
						echo '</form>';
						//form-inline
						...
						echo form_open('manage_account/modify_account', 'class="form-group"');
							echo '<div class="col-md-4">';
							echo '<h3>Change your account information</h3>';
								//form-group
								echo '<div class="form-group">';
								...
								//form-group
								echo '<div class="form-group">';
									echo form_submit('modify_account_info','Modify','class="btn btn-default"');
									echo '<button type="button" class="btn btn-default" onclick="location.href='."'".site_url().'/manage_account/index'."'".'">Back</button>';
								echo '</div>';
							echo '</div>';
						echo '</form>';
